...
public class TenantService {
    ...
    // TODO gestion du cas d'échec partiel
    public CreateTenantOutput createTenant(CreateTenantCommand tenantCommand) {
        ...
        if (tenantRepository.existsBySlug(tenantCommand.tenantSlug())) {
            throw new ResourceAlreadyExistsException(Tenant.class.getSimpleName(), "Slug", tenantCommand.tenantSlug());
        }
